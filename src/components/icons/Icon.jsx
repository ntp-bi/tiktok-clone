...
export const ThemeIcon = ({ width = "1em", height = "1em", className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const LanguageIcon = ({ className, width = "1em", height = "1em" }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const KeyboardIcon = ({ className, width = "1em", height = "1em" }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const LogOutIcon = ({ className, width = "1em", height = "1em" }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const GearIcon = ({ className, width = "1em", height = "1em" }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const CommentSidebarIcon = ({
    width = "2.4rem",
    height = "2.4rem",
    className,
}) => (
...
export const FollowingIconActiveIcon = ({
    width = "2.4rem",
    height = "2.4rem",
    className,
}) => (
...
export const QRIcon = ({ className, width = "1em", height = "1em" }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const XMarkIcon = ({ className, width = "1em", height = "1em" }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const BanIcon = ({ className, width = "1.6rem", height = "1.6rem" }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const TryIcon = ({ className, width = "1.9rem", height = "1.9rem" }) => (
    <svg
        fill="currentColor"
        viewBox="0 0 48 48"
        xmlns="http://www.w3.org/2000/svg"
